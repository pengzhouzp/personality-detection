...
#don't run this line
history=modellstm.fit([X_train,ma_train],y_train[:,2],validation_data=[[X_test,ma_test],y_test[:,2]],epochs=50, batch_size=200,callbacks=callbacks)

modellstm.save_weights('AGR.h5')
# In[53]:
...
fig.savefig('learning_AGR_50drop.png')
