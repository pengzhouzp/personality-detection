...
history=model.fit([X_train,ma_train],y_train_EXT,validation_data=[[X_test,ma_test],y_test_EXT],epochs=30, batch_size=200 , callbacks=callbacks)

model.save('cnn_EXT.h5')
