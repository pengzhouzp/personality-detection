...
classification_layer = Dense(1, activation='sigmoid',name='Dense_out')(fully_connected)
...
history=model.fit([X_train,ma_train],y_train_NEU,validation_data=[[X_test,ma_test],y_test_NEU],epochs=30, batch_size=200 , callbacks=callbacks)

model.save('cnn_NEU.h5')
