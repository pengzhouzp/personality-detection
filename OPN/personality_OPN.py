...
#don't run this line
history=modellstm.fit([X_train,ma_train],y_train[:,4],validation_data=[[X_test,ma_test],y_test[:,4]],epochs=50, batch_size=200,callbacks=callbacks)

modellstm.save_weights('OPN.h5')
# In[53]:
...
fig.savefig('learning_OPN_50drop.png')
