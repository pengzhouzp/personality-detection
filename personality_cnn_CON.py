...
history=model.fit([X_train,ma_train],y_train_CON,validation_data=[[X_test,ma_test],y_test_CON],epochs=30, batch_size=200 , callbacks=callbacks)

model.save('cnn_CON.h5')
