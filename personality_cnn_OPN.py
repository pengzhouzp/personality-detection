...
history=model.fit([X_train,ma_train],y_train_OPN,validation_data=[[X_test,ma_test],y_test_OPN],epochs=30, batch_size=200 , callbacks=callbacks)

model.save('cnn_OPN.h5')
