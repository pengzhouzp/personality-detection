...
#don't run this line
history=modellstm.fit([X_train,ma_train],y_train,validation_data=[[X_test,ma_test],y_test],epochs=50, batch_size=200,callbacks=callbacks)

modellstm.save_weights('total.h5')
# In[53]:
...
fig.savefig('learning_total_50drop.png')
