...
#don't run this line
history=modellstm.fit([X_train,ma_train],y_train[:,0],validation_data=[[X_test,ma_test],y_test[:,0]],epochs=50, batch_size=200,callbacks=callbacks)

modellstm.save_weights('EXT.h5')
# In[53]:
...
fig.savefig('learning_EXT_50drop.png')
